...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Frampton.startdate'
        db.add_column(u'hamptons_frampton', 'startdate',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Frampton.length'
        db.add_column(u'hamptons_frampton', 'length',
                      self.gf('durationfield.db.models.fields.duration.DurationField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Frampton.startdate'
        db.delete_column(u'hamptons_frampton', 'startdate')

        # Deleting field 'Frampton.length'
        db.delete_column(u'hamptons_frampton', 'length')
    ...
    models = {
        ...
        u'hamptons.frampton': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'length': ('durationfield.db.models.fields.duration.DurationField', [], {'null': 'True', 'blank': 'True'}),
